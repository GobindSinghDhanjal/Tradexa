...
SECRET_KEY = 'django-insecure-4y4tk0qi8o)35pv(!=%1n)xh3^#gm#6h40bo=#%vqzdlaug+#%'
...
DATABASE_ROUTERS = ['routers.db_routers.Admin','routers.db_routers.User','routers.db_routers.Product']
